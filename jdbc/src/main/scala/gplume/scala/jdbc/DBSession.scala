...
import java.sql.{Connection, SQLException, SQLWarning, Statement}
...
case class DBSession(connection: Connection,
                readOnly: Boolean) extends Closeable {

  private val log = LoggerFactory.getLogger(DBSession.getClass)
